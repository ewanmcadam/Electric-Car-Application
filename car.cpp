...
{
    int x_choice;
    cout << "Enter starting x co-ordinate (must be a factor of 50): ";
    cin >> x_choice;
    ...
    {
		cout << "Error! Value not possible, please try again: ";
        vehicle::setX();
    }
}
...
{
    int y_choice;
    cout << "Enter starting y co-ordinate (must be a factor of 50): ";
    cin >> y_choice;
